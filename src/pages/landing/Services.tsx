            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <ul className="space-y-1">
                  ...
                  <li className="flex items-center space-x-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-black"></div>
                    <span className="text-black" style={{fontSize: '18px', fontWeight: '400'}}>Autonomous solutions.</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-black"></div>
                    <span className="text-black" style={{fontSize: '18px', fontWeight: '400'}}>Pool buggy transport.</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-black"></div>
                    <span className="text-black" style={{fontSize: '18px', fontWeight: '400'}}>Executive transport services.</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-black"></div>
                    <span className="text-black" style={{fontSize: '18px', fontWeight: '400'}}>Traffic management.</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 order-1 lg:order-2">
                ...
                <div className="space-y-0">
                  <h3 className="text-lg font-semibold text-gray-900">Commercial and sales advice</h3>
                  <p className="text-gray-600 leading-relaxed" style={{fontSize: '18px', fontWeight: '400'}}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <ul className="space-y-1">
                  ...
                  <li className="flex items-center space-x-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-black"></div>
                    <span className="text-black" style={{fontSize: '18px', fontWeight: '400'}}>Design and Install Signage.</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-black"></div>
                    <span className="text-black" style={{fontSize: '18px', fontWeight: '400'}}>Closed-circuit television (CCTV).</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-black"></div>
                    <span className="text-black" style={{fontSize: '18px', fontWeight: '400'}}>Traffic support material traffic cones, police barriers and water barriers.</span>
                  </li>
                </ul>
              </div>
              <div className="flex justify-center">
